package com.brunocarvalho.bookstoreeventsproducer.producer;
...
public class BookStoreEventProducer {
	...
	public ListenableFuture<SendResult<Integer, String>> senBookStoreEvent_Approach2(BookStoreEvent bookStoreEvent)
	...
	public SendResult<Integer, String> sendBookStoreEventSynchronous(BookStoreEvent bookStoreEvent)
		...
		try {
			...
			log.error("ExecutionException/InterruptedException Mandando uma mensagem com a exception {}",
					e.getMessage());
			throw e;
		} catch (Exception e) {
	...
	private void handleSuccess(Integer key, String value, SendResult<Integer, String> result) {
		log.info("Mensagem enviada com sucesso com o a key : {}  e com o valor {} , e com a partition {}", key, value,
